...
const EventsSidebar = ({sidebar, showSidebar, eventsSidebar, showEventsSidebar, eventsSidebarFromSidebar, isLoggedIn}) => {
	const { user } = useAuth();
			...
			<div className="event-sidebar">
				...
				<nav className={eventsSidebar ? "sidebar-menu active" : "sidebar-menu"} >
					...
					<button
						...
						onClick={() => eventsSidebarFromSidebar ? (showSidebar(), showEventsSidebar()) : showEventsSidebar()}
					>
